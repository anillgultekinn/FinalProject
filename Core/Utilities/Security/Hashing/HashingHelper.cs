...
{//hashingHelper; hash oluşturmaya ve hashi doğrulamaya yarar.
    public class HashingHelper
    {
        ...
        // sonradan sisteme girmek isteyen kişinin verdiği passwordun bizim veri kaynağımızdaki hash ile ilgili salta göre eşleşip eşleşmediğini verdiğimiz yerdir
